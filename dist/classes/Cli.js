...
class Cli {
    ...
    createMotorbike() {
        inquirer
            ...
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), answers.engineType, parseInt(answers.topSpeed), []);
